...
import com.example.apurvchaudhary.cameratest.R;
            ...
            while (true) {
                synchronized (mLock) {
                    ...
                    FirebaseVisionImageMetadata metadata = new
                            ...
                            .setWidth(previewW/4)
                            .setHeight(previewH/4)
                            .setFormat(FirebaseVisionImageMetadata.IMAGE_FORMAT_NV21)
                            .setRotation(mRotation)
                            .build();
                    outputFrame = FirebaseVisionImage.fromByteBuffer(quarterNV21(mPendingFrameData, previewW, previewH),metadata);
